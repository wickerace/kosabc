...
<div id="TopNavAbsolute" class="absolute top-[60px] flex items-center justify-between w-full px-5 z-10">
    <a href="{{route('home')}}"
        ...
        <img src="{{asset('assets/assets/images/icons/arrow-left-transparent.svg')}}" class="w-8 h-8" alt="icon">
    </a>
...
<main id="Details" class="relative flex flex-col rounded-t-[40px] py-5 pb-[10px] gap-4 bg-white z-10">
    ...
    <div id="Features" class="grid grid-cols-2 gap-x-[10px] gap-y-4 px-5">
        <div class="flex items-center gap-[6px]">
            <img src="{{asset('assets/assets/images/icons/location.svg')}}" class="w-[26px] h-[26px] flex shrink-0" alt="icon">
            <p class="text-ngekos-grey">Kota {{$boardingHouse->city->name}}</p>
        </div>
        <div class="flex items-center gap-[6px]">
            <img src="{{asset('assets/assets/images/icons/3dcube.svg')}}" class="w-[26px] h-[26px] flex shrink-0" alt="icon">
            <p class="text-ngekos-grey">In {{$boardingHouse->category->name}}</p>
        </div>
        <div class="flex items-center gap-[6px]">
            <img src="{{asset('assets/assets/images/icons/profile-2user.svg')}}" class="w-[26px] h-[26px] flex shrink-0" alt="icon">
            <p class="text-ngekos-grey">4 People</p>
        </div>
        <div class="flex items-center gap-[6px]">
            <img src="{{asset('assets/assets/images/icons/shield-tick.svg')}}" class="w-[26px] h-[26px] flex shrink-0" alt="icon">
        ...
        <div id="Testimonials-Tab" class="tab-content flex-col gap-5 hidden">
            <div class="flex flex-col gap-4">
                ...
                <div class="flex">
                    ...
                    <img src="{{asset('assets/assets/images/icons/Star 1.svg')}}" class="w-[22px] h-[22px] flex shrink-0"
                    alt="">
                    @endfor
                </div>
            </div>
